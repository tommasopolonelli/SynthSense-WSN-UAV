...
*******************************************************************************************************************/
/* enable the TX to check the MAX supported bitrate */
//#define MAX_STREAM_TX
//#define MAX_STREAM_RX
#define IoT_MODE
#define COMBO_UWB_POWERTRANSF
//#define LOW_POW_LISTENING
...
#if defined(MAX_STREAM_TX) | defined(MAX_STREAM_RX)
#ifdef IoT_MODE
#error "Only one allowed"
#endif
#endif
...
#define LPL_RX_SNIFF_TIME 1563//6250
...
#define LPL_SHORT_SLEEP_SNOOZE_TIME 250 //1236

/* "Long sleep" time, in milliseconds. See NOTE 3 below. */
#define LONG_SLEEP_TIME_MS 14860
...
#define ANCH_RESPONSE_MSG_LEN               13              // FunctionCode(1), RespOption (1), OptionParam(2), Measured_TOF_Time(5), Measured_PowerTransfer_Volt(4)
#else
...
#define STANDARD_FRAME_SIZE         1023
...
//#define POLL_SLEEP_DELAY					30 //ms
#define POLL_SLEEP_DELAY					500 //ms	//NOTE 200 gives 5 Hz range period
...
typedef struct
{
    ...
    lpl_states_e LPListenEabled; //This flag is set to 1 when the DW1000 in in Low Power Listening
    ...
    /* Power transfer transmission from Anchor to TAG through Response Message RTLS_DEMO_MSG_ANCH_RESP */
    float TX_PowerTransfer_V;
    float RX_PowerTransfer_V;
...
float instance_get_PowerTransfer(void);
void instance_set_PowerTransfer(float x);
